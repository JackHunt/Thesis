...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=.5\linewidth]{figures/intro/basic_slam.pdf}
  \caption[Basic SLAM Pipeline]{A high level overview of the basic SLAM pipeline..}
~\label{figure:basic_slam}
\end{figure}

A typical reconstruction using such a system is given in Figure~\ref{figure:room_recon_example}.
\begin{figure}[!htbp]
  \centering
...
\afterpage{
  \begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\linewidth]{figures/intro/spaint-teaser.png}
