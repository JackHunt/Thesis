...
In the same year, \textit{Censi}~\cite{Censi2008} introduced Point-to-Line ICP (PL-ICP), a 
...
system itself is based on Monocular Extended Kalman Filter (EKF) SLAM~\cite{Smith1990} with 
semantics added to points via correspondences between Speeded Up Robust Features (SURF)~\cite{Bay2006} 
