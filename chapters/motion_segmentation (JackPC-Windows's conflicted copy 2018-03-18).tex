...
$\frac{\partial \mathbf{R}}{\partial \{\alpha, \beta, \gamma\}}$ may be combined
in to the following Rotation Jacobian
\begin{equation}
  \label{eqn:rot_jac}
  \mathbf{J}_{R} =
  \begin{bmatrix}
  ...
  \end{bmatrix}
\end{equation}
likewise for the Translation Partial Derivatives
$\frac{\partial \mathbf{t}}{\partial \{t_{x}, t_{y}, t_{z}\}}$
\begin{equation}
  \label{eqn:trans_jac}
  \mathbf{J}_{t} =
  \begin{bmatrix}
