...
$\frac{\partial E}{\partial \mathbf{t}_{\bar{\lambda}}} \forall \bar{\lambda} \in \{x, y, z\}$ 
...
\begin{equation}
  ...
  \frac{\partial E}{\partial \mathbf{t}_{\bar{\lambda}}} =
  \sum_{p \in \mathbf{\Omega}}
  \frac{\phi(.)}{\norm{\phi(.)}}
  \bigg[ \frac{\partial \mathbf{t}}{\partial \bar{\lambda}}\bigg]^{T}
  \mathcal{N}(\bar{\mathbf{x}})
\end{equation}

The translational partial derivatives
$\frac{\partial \mathbf{t}}{\partial \lambda} \forall \bar{\lambda} \in \{x, y, z\}$ may also 
...
following transformation (noting that $\mathbf{x}_{v}$ is in homogeneous 
...
\begin{equation}
  ...
  \end{bmatrix}
\end{equation}
Where in Equation \ref{eqn:camera_matrix}, $f_{x}$, $f_{y}$, $s$, $x_{0}$ and $y_{0}$ are 
the focal lengths, scale and camera principal points respectively.
