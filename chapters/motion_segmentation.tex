...
In Algorithm~\ref{alg:raycast} it should be noted that the loop over image pixels \( \bm{\Omega}_{x, y} \) 
...
Algorithm~\ref{alg:moseg} is trivially parallelisable with commodity GPU hardware.
