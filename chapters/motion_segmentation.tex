...
\begin{figure}[h]
  ...
  \caption[TSDF split in to Voxel Blocks]{A graphical representation of an SDF/TSDF with it's 
  Voxels subdivided into Voxel Blocks. In the above, $vb$ represents Voxel Blocks and $v$ Voxels.}
\end{figure}
...
\begin{figure}[h]
  ...
  Three Dimensional Signed Distance Function.}
\end{figure}
