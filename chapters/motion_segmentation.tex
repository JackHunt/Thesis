...
\begin{figure}[!htbp]
  \centering
  \begin{tabular}{ccc}
    \includegraphics[height=.22\linewidth]{figures/moseg/original_sitting.png} &
    \includegraphics[height=.22\linewidth]{figures/moseg/infinitam_sitting.png} &
    \includegraphics[height=.22\linewidth]{figures/moseg/moseg_sitting.png}\\
    (a) & (b) & (c)
  \end{tabular}
...
\begin{figure}[!htbp]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=.36\linewidth]{figures/moseg/chair0.png} &
    \includegraphics[height=.36\linewidth]{figures/moseg/chair1.png} \\
    (a) & (b) \\
    \includegraphics[height=.36\linewidth]{figures/moseg/chair2.png} &
    \includegraphics[height=.36\linewidth]{figures/moseg/chair3.png} \\
    (c) & (d)
  \end{tabular}
