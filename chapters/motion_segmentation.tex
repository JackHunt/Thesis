...
proceeds as follows for a voxel \(\bm{x}_{v} \in \bm{\Phi}\). A graphical depiction 
of the 2D case of a TSDF truncation region is given in Figure~\ref{figure:moseg_truncation}.
\begin{equation}
...
\end{figure}
~\footnotetext{Image copyright: \textit{Whelan et al}~\cite{Whelan2014}.}
