...
Conditional Random Field (CRF)~\cite{BishopPRML} framework. Textured renderings 
of various objects reconstructed with the proposed system are given in 
Figure~\ref{figure:probobj_teaser}.
...
During the fusion process, the PDF's or PMF's of these distributions are evaluated on the latest 
...
\begin{figure}[!htbp]
  ...
  \caption[Probabilistic Object Reconstruction Qualitative Results I]
  {
    \begin{tabular}[t]{@{}l@{}}
      ...
      (b) The proposed system reconstructing 
...
\begin{figure}[!htbp]
  ...
  \caption[Probabilistic Object Reconstruction Qualitative Results II]
  {
    \begin{tabular}[t]{@{}l@{}}
      ...
      (b) The proposed system reconstructing same the object from RGBD\\ observations of the 
...
pipeline with object segmentation. 
