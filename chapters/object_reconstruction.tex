...
\begin{align}
  ...
  % Line 7.
  &= \lim_{y\to -\infty} \Big[ \frac{1}{w} + C \Big]_{y}^{b}\\
  % Line 8.
  &= \lim_{y\to -\infty} \Big[ \frac{1}{1 + e^{p}} + C \Big]_{y}^{b}\\
  % Line 9.
  &= \lim_{y\to -\infty} \Big[ \frac{1}{1 +e^{\frac{u}{\sigma}}} + C \Big]_{y}^{b}\\
  % Line 10.
  &= \lim_{y\to -\infty} \Big[ \frac{1}{1 + e^{\frac{-\Phi + \mu}{\sigma}}} + C \Big]_{y}^{b}
\end{align}
