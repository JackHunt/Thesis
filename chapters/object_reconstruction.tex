...
For Pose evaluation, the \textit{3D Object Reconstrucytion} subset of the 
...
\begin{table}[ht]
  ...
  \begin{tabular}{l@{\hskip 1cm} c c}
    \emph{Sequence Name} & \emph{Proposed Approach ATE (m)} & \emph{InfiniTAM + Segmentation ATE (m)}\\
    \midrule
