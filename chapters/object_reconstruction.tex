...
~\ref{figure:probobj_shape_prior}.
\begin{figure}[!htbp]
  \centering
...
the prior \( P(\Phi) \) is defined as follows.
\begin{align}
  \label{eqn:probobj_surface_prior}
  \bar{P}(\Phi) \propto{}& 1 - \left. \int_{-\infty}^{b} \frac
  {e^{-\frac{\Phi - \mu}{\sigma}}}
  {\sigma {\Big( 1 + e^{-\frac{\Phi - \mu}{\sigma}} \Big)}^{2}} \intd{\Phi}
  \right\rvert_{\mu = 4, \sigma = 0.7}\\
  \propto& 1 - \left. \frac{1}{1 + e^{\frac{-\Phi + \mu}{\sigma}}}
  \right\rvert_{\mu = 4, \sigma = 0.7}
\end{align}
