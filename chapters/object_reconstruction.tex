...
target Energy function. The derivation of the Partial Derivatives with respect
...
\begin{align}
  ...
  % Line 1.
  \frac{\partial}{\partial \tau} \ln P(\Omega, p | L_{s, s'}) &=
  ...
  \frac{\partial}{\partial \tau} \ln(1 + e^{-\Phi}) \Bigg]\\
  % Line 2.
