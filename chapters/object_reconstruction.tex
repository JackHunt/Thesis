...
quarterly intervals for each sequence. 

\begin{figure}[ht]
  \label{fig:probobj_rock_s3d}
  \centering
  \begin{tabular}{c}
    \includegraphics[width=.25\linewidth]{figures/object_recon/strips/rock.png} \\
    (a) \\
    \includegraphics[width=.25\linewidth]{figures/object_recon/strips/rock_s3d.png} \\
    (b) \\
  \end{tabular}
  \caption{}
\end{figure}
...
of the two approaches in this comparison is that in the proposed system, only the 
observed points of the live frame and of the reconstruction that belong to the 
