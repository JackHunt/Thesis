...
reconstruction and correction is given in Algorithm~\ref{alg:probobj}
...
The process outlined in Algorithm~\ref{alg:probobj} is highly amenable to GPU parallelisation. 
...
Finally, with careful implementationa and use of atomic primitives, the max flow procedure performed 
