...
\begin{figure}[!htbp]
  ...
  {
    \begin{tabular}[t]{@{}l@{}}
      Slices of a Signed Distance Function embedding \( \bm{\Phi} \in \mathbb{R}^{40 \times 40 \times 40} \)
...
over two training sessions, with differing learning rates. Figure~\ref{figure:spp_train} provides the training and validation 
...
\begin{table}[!htbp]
  \begin{center}
    \begin{tabular}{l c c}
      Data Subset & Orientation (Rotational) MSE & \( z \) Translational MSE \\
      \midrule
      Training & TODO\\
      Testing & TODO
    \end{tabular}
...
Given in Table~\ref{} are metrics pertaining to the similarity between the ground truth segmentation mask and the 2D region to 
