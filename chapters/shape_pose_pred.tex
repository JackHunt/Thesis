...
component outlined in Figure~\ref{} must be differentiable. The formulation of the 
posterior mean of Equation~\ref{eqn:eqn:spp_mean_var} is differentiable an it's gradient 
...
network component following the Resnet-50 CNN of Figure~\ref{}. The output of the network 
...
component of the model outlined in Figure~\ref{}, as with the latent pose point of Section
